export default function ProjectsIntro() {
  return (
    <div className="text-white h-full flex items-center justify-center lg:justify-end">
      <div className="w-full max-w-[80%] lg:max-w-[85%] lg:pl-[0.5%] lg:pr-[5%]">
        <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-relaxed">
